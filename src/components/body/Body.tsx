...
import {Button, ButtonEqual, ButtonSymbol, CalculatorBody, Icon, IconTheme} from "./Body.styles";
  ...
  return (
    <CalculatorBody>
      ...
      <ButtonSymbol onClick={toggleThemeHandler}>
        <IconTheme isDisplay={UiState.isLightTheme}
        ...
        <IconTheme isDisplay={UiState.isDarkTheme}
                   xmlns="http://www.w3.org/2000/svg"
                   fill="none"
                   viewBox="0 0 24 24"
                   strokeWidth="1.5"
