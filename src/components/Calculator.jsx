...
const Calculator = () => {
  ...
  const {previousOperand, currentOperand, operator, result, resultHighlight} = calculationState;
  const displayFormula = [previousOperand, operator, currentOperand].join("");
